...
# flag server server.worlds.enabled_worlds:world|avarus|orbis|arboretum|baumschule|silberlab|world_lager|dungeon|orcus|world_nether|kaos|world_the_end|hortusmanium