...
# klassische MC Musik:
# MUSIC_OVERWORLD_JUNGLE MUSIC_OVERWORLD_FLOWER_FOREST MUSIC_CREATIVE MUSIC_OVERWORLD_FROZEN_PEAKS MUSIC_OVERWORLD_OLD_GROWTH_TAIGA MUSIC_OVERWORLD_SNOWY_SLOPES MUSIC_OVERWORLD_SPARSE_JUNGLE
  ...
  events:
    ...
    on player changes world to zeitkapsel:
      ...
      - if <player.has_flag[zeitkapsel_songplaying]>:
          - stop
      - flag <player> zeitkapsel_playlist:MUSIC_OVERWORLD_JUNGLE|MUSIC_OVERWORLD_FLOWER_FOREST|MUSIC_CREATIVE|MUSIC_OVERWORLD_FROZEN_PEAKS|MUSIC_OVERWORLD_OLD_GROWTH_TAIGA|MUSIC_OVERWORLD_SNOWY_SLOPES|MUSIC_OVERWORLD_SPARSE_JUNGLE
